    ...
    <footer className="relative bg-background border-t border-border">
      ...
      <div className="container mx-auto px-4 lg:px-8 py-16">
        <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-12">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="flex gap-4">
              <a
                ...
                className="w-10 h-10 rounded-lg bg-muted flex items-center justify-center hover:bg-accent hover:text-accent-foreground transition-colors"
              >
          ...
          <div>
            <h4 className="font-semibold text-foreground mb-4">Tecnología</h4>
            <ul className="space-y-3">
      ...
      <motion.button
        ...
        whileTap={{ scale: 0.9 }}
        className="fixed bottom-8 right-8 w-12 h-12 rounded-xl bg-accent text-accent-foreground flex items-center justify-center shadow-lg glow-gold z-50"
      >
